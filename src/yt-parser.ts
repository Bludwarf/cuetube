...
export class ytparser {
     ...
     */
    static newDiscFromVideo(videoPage: GoogleApiYouTubePaginationInfo<GoogleApiYouTubeVideoResource>, videoUrl: string, options: ParseTrackObject) {
     ...
     * Remplace CueService.extractTracks
     */
    static newDiscFromVideoSnippet(snippet: GoogleApiYouTubeVideoResource["snippet"], videoUrl: string, contentDetails?: any, options?: ParseTrackObject) {
        return newDiscFromVideoSnippet(snippet, videoUrl, contentDetails, options);
    }
 ...
 * @returns {Array}
 */
function newDiscFromVideoSnippet(snippet: GoogleApiYouTubeVideoResource["snippet"], videoUrl: string, contentDetails?: GoogleApiYouTubeVideoResource["contentDetails"], options?: ParseTrackObject) {
