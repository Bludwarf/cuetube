// FIXME : fork https://www.npmjs.com/package/@types/gapi.youtube

export interface GoogleApiYouTubePlaylistItemResource {
  /**
  ...
  snippet?: {
     ...
     * the key is the name of the thumbnail image, and the value is an object that contains other information about the thumbnail.
     */
  ...
  contentDetails?: {
    /**
     * The ID that YouTube uses to uniquely identify a video. To retrieve the video resource, set the id query parameter to this value in
     * your API request.
     */
    videoId: string;
    /**
     * The time, measured in seconds from the start of the video, when the video should start playing. (The playlist owner can specify
     * the times when the video should start and stop playing when the video is played in the context of the playlist.)
     * The default value is 0.
     */
    startAt: string;
    /**
     * The time, measured in seconds from the start of the video, when the video should stop playing. (The playlist owner can specify
     * the times when the video should start and stop playing when the video is played in the context of the playlist.) By default,
     * assume that the video.endTime is the end of the video.
     */
    endAt: string;
    /**
  ...
  status?: {
    /**
     * The playlist items privacy status. The channel that uploaded the video that the playlist item represents can set this value
     * using either the videos.insert or videos.update method.
     */
    privacyStatus: string;
  };
}

export interface GoogleApiYouTubePaginationInfo<T> {
