///<reference path="../@types/CueParser.d.ts"/>
...
export class GoogleDrivePersistence extends Persistence {
 ...
 "error": {
  ...
  "message": "User Rate Limit Exceeded"
    ...
    private getRootFolder(): Promise<gapi.client.drive.File> {
        return this.getGoogleFolder('CueTube', null, 'rootFolder');
    }

    private getFolders(): Promise<{
        collectionsFolder: gapi.client.drive.File,
        cuesFolder: gapi.client.drive.File,
        plCuesFolder: gapi.client.drive.File
    }> {
     ...
     */
    private getGoogleFolder(name: string, parentId: string, field: any, fieldObject : any = this): Promise<gapi.client.drive.File> {
    ...
    private getCollectionFile(collectionName: string): Promise<gapi.client.drive.File> {
  ...
  /**
    ...
    private getCueFile(discId: string): Promise<gapi.client.drive.File> {
    ...
    private getDiscFolder(discId: string): Promise<gapi.client.drive.File> {
     ...
     * @return {Promise<gapi.client.drive.File>}
     */
    private getDiscFolder3Levels(discId: string): Promise<gapi.client.drive.File> {
        return this.getFolders()
    ...
    private getGoogleFolders(names: string[], parentId: string, files: gapi.client.drive.File[] = [], fieldObject = this): Promise<gapi.client.drive.File[]> {
    ...
    postDisc(discId: string, disc: Disc): Promise<Disc> {
        ...
        let discFolder: gapi.client.drive.File;
        return this.getDiscFolder(discId)
            .then((folder) => {
                discFolder = folder;
